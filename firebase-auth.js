...
class l extends Error {
    constructor(e, t, n) {
        super(t), this.code = e, this.customData = n, this.name = "FirebaseError", Object.setPrototypeOf(this, l.prototype), Error.captureStackTrace && Error.captureStackTrace(this, h.prototype.create)
    }
}
class h {
    constructor(e, t, n) {
...
function W(e, t, n) {
    ...
    return new h("auth", "Firebase", i).create(t, {
        appName: e.name
    })
}
...
function Y(e) {
    ...
    let t = J.get(e);
    return t ? ($(t instanceof e, "Instance stored in cache mismatched with class"), t) : (t = new e, J.set(e, t), t)
}
...
function te() {
    return !("undefined" != typeof navigator && navigator && "onLine" in navigator && "boolean" == typeof navigator.onLine && (Z() || function() {
...
class ne {
    constructor(e, t) {
        this.shortDelay = e, this.longDelay = t, $(t > e, "Short delay should be less than long delay!"), this.isMobile = "undefined" != typeof window && !!(window.cordova || window.phonegap || window.PhoneGap) && /ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(a()) || "object" == typeof navigator && "ReactNative" === navigator.product
    }
    get() {
        return te() ? this.isMobile ? this.longDelay : this.shortDelay : Math.min(5e3, this.shortDelay)
    }
}
...
class re {
    ...
    static fetch() {
        return this.fetchImpl ? this.fetchImpl : "undefined" != typeof self && "fetch" in self ? self.fetch : void K("Could not find fetch implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")
    }
    static headers() {
        return this.headersImpl ? this.headersImpl : "undefined" != typeof self && "Headers" in self ? self.Headers : void K("Could not find Headers implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")
    }
    static response() {
        return this.responseImpl ? this.responseImpl : "undefined" != typeof self && "Response" in self ? self.Response : void K("Could not find Response implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")
    }
}
const se = {
...
async function ce(e, t, n, i, r = {}) {
    return ue(e, r, (async () => {
        ...
        return a["Content-Type"] = "application/json", e.languageCode && (a["X-Firebase-Locale"] = e.languageCode), re.fetch()(le(e, e.config.apiHost, n, o), Object.assign({
            method: t,
            headers: a,
...
async function we(e) {
    ...
    const n = e.auth,
        ...
        r = await Ie(e, async function(e, t) {
...
class ke {
    ...
    updateFromServerResponse(e) {
        ...
        const t = "expiresIn" in e && void 0 !== e.expiresIn ? Number(e.expiresIn) : function(e) {
            const t = _e(e);
            return B(t, "internal-error"), B(void 0 !== t.exp, "internal-error"), B(void 0 !== t.iat, "internal-error"), Number(t.exp) - Number(t.iat)
        }(e.idToken);
    ...
    async refresh(e, t) {
        const {
            ...
            const n = await ue(e, {}, (async () => {
                ...
                return o["Content-Type"] = "application/x-www-form-urlencoded", re.fetch()(s, {
                    method: "POST",
                    headers: o,
                    body: n
                })
    ...
    static fromJSON(e, t) {
        ...
        return n && (B("string" == typeof n, "internal-error", {
            appName: e
        }), s.refreshToken = n), i && (B("string" == typeof i, "internal-error", {
            appName: e
        }), s.accessToken = i), r && (B("number" == typeof r, "internal-error", {
            appName: e
...
class Ae {
    constructor(e) {
        ...
        this.providerId = "firebase", this.proactiveRefresh = new ye(this), this.reloadUserInfo = null, this.reloadListener = null, this.uid = t, this.auth = n, this.stsTokenManager = i, this.accessToken = i.accessToken, this.displayName = r.displayName || null, this.email = r.email || null, this.emailVerified = r.emailVerified || !1, this.phoneNumber = r.phoneNumber || null, this.photoURL = r.photoURL || null, this.isAnonymous = r.isAnonymous || !1, this.tenantId = r.tenantId || null, this.providerData = r.providerData ? [...r.providerData] : [], this.metadata = new Te(r.createdAt || void 0, r.lastLoginAt || void 0)
    }
    async getIdToken(e) {
    ...
    _clone(e) {
        return new Ae(Object.assign(Object.assign({}, this), {
            auth: e,
    ...
    async _updateTokensIfNecessary(e, t = !1) {
        let n = !1;
        e.idToken && e.idToken !== this.stsTokenManager.accessToken && (this.stsTokenManager.updateFromServerResponse(e), n = !0), t && await we(this), await this.auth._persistUserIfCurrent(this), n && this.auth._notifyListenersIfCurrent(this)
    }
    async delete() {
        const e = await this.getIdToken();
        return await Ie(this, async function(e, t) {
    ...
    static _fromJSON(e, t) {
        ...
        B("string" == typeof _, e, "internal-error"), be(d, e.name), be(l, e.name), B("boolean" == typeof I, e, "internal-error"), B("boolean" == typeof y, e, "internal-error"), be(h, e.name), be(p, e.name), be(f, e.name), be(m, e.name), be(g, e.name), be(v, e.name);
        const k = new Ae({
            uid: _,
            auth: e,
            email: l,
...
class ze {
    ...
    async initializeCurrentUser(e) {
        ...
        return B(this._popupRedirectResolver, this, "argument-error"), await this.getOrInitRedirectPersistenceManager(), this.redirectUser && this.redirectUser._redirectEventId === i._redirectEventId ? this.directlySetCurrentUser(i) : this.reloadAndSetCurrentUserOrClear(i)
    }
    ...
    async getOrInitRedirectPersistenceManager(e) {
        if (!this.redirectPersistenceManager) {
            ...
            B(t, this, "argument-error"), this.redirectPersistenceManager = await Oe.create(this, [Y(t._redirectPersistence)], "redirectUser"), this.redirectUser = await this.redirectPersistenceManager.getCurrentUser()
        }
    ...
    registerStateListener(e, t, n, i) {
        ...
        return B(s, this, "internal-error"), s.then((() => r(this.currentUser))), "function" == typeof t ? e.addObserver(t, n, i) : e.addObserver(t)
    }
    ...
    _logFramework(e) {
        e && !this.frameworks.includes(e) && (this.frameworks.push(e), this.frameworks.sort(), this.clientVersion = qe(this.config.clientPlatform, this._getFrameworks()))
    }
    _getFrameworks() {
...
function Ke(e, t, n) {
    const i = Ge(e);
    B(i._canInitEmulator, i, "emulator-config-failed"), B(/^https?:\/\//.test(t), i, "invalid-emulator-scheme");
...
class rt extends Ye {
    ...
    _getReauthenticationResolver(e) {
        return async function(e, t) {
            return de(e, "POST", "/v1/accounts:signInWithPhoneNumber", ae(e, Object.assign(Object.assign({}, t), {
                operation: "REAUTH"
            })), it)
        }(e, this._makeVerificationRequest())
    }
...
class st {
    constructor(e) {
        ...
        B(c && u && d, "argument-error"), this.apiKey = c, this.operation = d, this.code = u, this.continueUrl = null !== (r = a.continueUrl) && void 0 !== r ? r : null, this.languageCode = null !== (s = a.languageCode) && void 0 !== s ? s : null, this.tenantId = null !== (o = a.tenantId) && void 0 !== o ? o : null
    }
    static parseLink(e) {
        const t = function(e) {
            const t = v(_(e)).link,
...
at.PROVIDER_ID = "password", at.EMAIL_PASSWORD_SIGN_IN_METHOD = "password", at.EMAIL_LINK_SIGN_IN_METHOD = "emailLink";
class ct {
    constructor(e) {
...
class dt extends ut {
    ...
    _credential(e) {
        return B(e.idToken || e.accessToken, "argument-error"), nt._fromParams(Object.assign(Object.assign({}, e), {
            providerId: this.providerId,
...
async function yt(e) {
    var t;
    const n = Ge(e);
    if (await n._initializationPromise, null === (t = n.currentUser) || void 0 === t ? void 0 : t.isAnonymous) return new _t({
        user: n.currentUser,
        providerId: null,
...
class Tt extends l {
    constructor(e, t, n, i) {
        var r;
        super(t.code, t.message), this.operationType = n, this.user = i, Object.setPrototypeOf(this, Tt.prototype), this.customData = {
            appName: e.name,
...
function Mt(e, t, n) {
    var i;
    B((null === (i = n.url) || void 0 === i ? void 0 : i.length) > 0, e, "invalid-continue-uri"), B(void 0 === n.dynamicLinkDomain || n.dynamicLinkDomain.length > 0, e, "invalid-dynamic-link-domain"), t.continueUrl = n.url, t.dynamicLinkDomain = n.dynamicLinkDomain, t.canHandleCodeInApp = n.handleCodeInApp, n.iOS && (B(n.iOS.bundleId.length > 0, e, "missing-ios-bundle-id"), t.iOSBundleId = n.iOS.bundleId), n.android && (B(n.android.packageName.length > 0, e, "missing-android-pkg-name"), t.androidInstallApp = n.android.installApp, t.androidMinimumVersionCode = n.android.minimumVersion, t.androidPackageName = n.android.packageName)
}
async function Ut(e, t, n) {
    ...
    n && Mt(i, r, n), await async function(e, t) {
        return Ze(e, t)
    }(i, r)
}
...
async function xt(e, t) {
    ...
    let s = null;
    return i.mfaInfo && (s = Dt._fromServerResponse(Ge(n), i.mfaInfo)), {
        data: {
...
async function Wt(e, t, n) {
    ...
    B(n.handleCodeInApp, i, "argument-error"), n && Mt(i, r, n), await async function(e, t) {
        return Ze(e, t)
    }(i, r)
}
...
async function Bt(e, t) {
    const n = {
            identifier: t,
            continueUri: Z() ? Q() : "http://localhost"
        },
        {
            signinMethods: i
        } = await async function(e, t) {
...
function on(e) {
    ...
    return t.isAnonymous && !n ? {
        ...
        if (!i && (null == e ? void 0 : e.idToken)) {
            const i = null === (n = null === (t = _e(e.idToken)) || void 0 === t ? void 0 : t.firebase) || void 0 === n ? void 0 : n.sign_in_provider;
...
class mn {
    ...
    static fromJSON(e) {
        ...
        if (null == e ? void 0 : e.multiFactorSession) {
            if (null === (t = e.multiFactorSession) || void 0 === t ? void 0 : t.pendingCredential) return mn._fromMfaPendingCredential(e.multiFactorSession.pendingCredential);
            if (null === (n = e.multiFactorSession) || void 0 === n ? void 0 : n.idToken) return mn._fromIdtoken(e.multiFactorSession.idToken)
        }
        return null
    }
}
...
function vn(e, t) {
    ...
    const i = T(e),
        r = t;
    return B(t.customData.operationType, i, "argument-error"), B(null === (n = r.customData._serverResponse) || void 0 === n ? void 0 : n.mfaPendingCredential, i, "argument-error"), gn._fromError(i, r)
}
class _n {
    constructor(e) {
        this.user = e, this.enrolledFactors = [], e._onReload((t => {
            t.mfaInfo && (this.enrolledFactors = t.mfaInfo.map((t => Dt._fromServerResponse(e.auth, t))))
        }))
    }
    static _fromUser(e) {
        return new _n(e)
    ...
    async unenroll(e) {
        const t = "string" == typeof e ? e : e.uid,
            ...
            i = await Ie(this.user, (r = this.user.auth, s = {
                idToken: n,
                mfaEnrollmentId: t
        ...
        this.enrolledFactors = this.enrolledFactors.filter((({
            uid: e
        }) => e !== t)), await this.user._updateTokensIfNecessary(i);
        try {
...
class Fn {
    ...
    async initializeReceiver() {
        this.receiver = An._getInstance(On() ? self : null), this.receiver._subscribe("keyChanged", (async (e, t) => ({
    ...
    async _set(e, t) {
        return this._withPendingWrite((async () => (await this._withRetries((n => Mn(n, e, t))), this.localCache[e] = t, this.notifyServiceWorker(e))))
    }
    async _get(e) {
    ...
    async _remove(e) {
        return this._withPendingWrite((async () => (await this._withRetries((t => Un(t, e))), delete this.localCache[e], this.notifyServiceWorker(e))))
    }
    async _poll() {
...
class Gn {
    constructor() {
        var e;
        this.hostLanguage = "", this.counter = 0, this.librarySeparatelyLoaded = !!(null === (e = Nn().grecaptcha) || void 0 === e ? void 0 : e.render)
    }
    load(e, t = "") {
        return B(function(e) {
            return e.length <= 6 && /^\s*[a-zA-Z0-9\-]*\s*$/.test(e)
        }(t), e, "argument-error"), this.shouldResolveImmediately(t) ? Promise.resolve(Nn().grecaptcha) : new Promise(((n, i) => {
            ...
            xn(`https://www.google.com/recaptcha/api.js??${g({onload:Wn,render:"explicit",hl:t})}`).catch((() => {
    ...
    shouldResolveImmediately(e) {
        var t;
        return !!(null === (t = Nn().grecaptcha) || void 0 === t ? void 0 : t.render) && (e === this.hostLanguage || this.counter > 0 || this.librarySeparatelyLoaded)
    }
}
class Bn {
    async load(e) {
...
class $n {
    constructor(e, t = Object.assign({}, Kn), n) {
        this.parameters = t, this.type = "recaptcha", this.destroyed = !1, this.widgetId = null, this.tokenChangeListeners = new Set, this.renderPromise = null, this.recaptcha = null, this.auth = Ge(n), this.isInvisible = "invisible" === this.parameters.size, B("undefined" != typeof document, this.auth, "operation-not-supported-in-this-environment");
        const i = "string" == typeof e ? document.getElementById(e) : e;
        B(i, this.auth, "argument-error"), this.container = i, this.parameters.callback = this.makeTokenCallback(this.parameters.callback), this._recaptchaLoader = this.auth.settings.appVerificationDisabledForTesting ? new Bn : new Gn, this.validateStartingState()
    }
    async verify() {
    ...
    async init() {
        B(Z() && !On(), this.auth, "internal-error"), await
        function() {
            let e = null;
...
async function Zn(e, t, n) {
    ...
    try {
        let s;
        if (B("string" == typeof r, e, "argument-error"), B("recaptcha" === n.type, e, "argument-error"), s = "string" == typeof t ? {
                phoneNumber: t
            } : t, "session" in s) {
            const t = s.session;
            if ("phoneNumber" in s) {
...
class ai {
    ...
    resolve(e) {
        $(this.pendingPromise, "Pending promise was never set"), this.pendingPromise.resolve(e), this.unregisterAndCleanUp()
    }
    reject(e) {
        $(this.pendingPromise, "Pending promise was never set"), this.pendingPromise.reject(e), this.unregisterAndCleanUp()
    }
...
class hi extends ai {
    constructor(e, t, n, i, r) {
        super(e, t, i, r), this.provider = n, this.authWindow = null, this.pollId = null, hi.currentPopupAction && hi.currentPopupAction.cancel(), hi.currentPopupAction = this
    }
    ...
    cleanUp() {
        this.authWindow && this.authWindow.close(), this.pollId && window.clearTimeout(this.pollId), this.authWindow = null, this.pollId = null, hi.currentPopupAction = null
    }
    pollUserCancellation() {
        const e = () => {
            ...
            }), 2e3): this.pollId = window.setTimeout(e, ci.get())
        };
        e()
    }
}
...
class bi {
    ...
    hasEventBeenHandled(e) {
        return Date.now() - this.lastProcessedEventTime >= 6e5 && this.cachedEventUids.clear(), this.cachedEventUids.has(Ai(e))
    }
    saveEventToCache(e) {
...
function Mi(e) {
    return Li = Li || function(e) {
        return new Promise(((t, n) => {
            ...
            if (null === (r = null === (i = Nn().gapi) || void 0 === i ? void 0 : i.iframes) || void 0 === r ? void 0 : r.Iframe) t(gapi.iframes.getContext());
            else {
...
function xi(e) {
    ...
    const n = t.emulator ? ie(t, "emulator/auth/iframe") : `https://${e.config.authDomain}/__/auth/iframe`,
        i = {
            apiKey: t.apiKey,
            appName: e.name,
            v: r
